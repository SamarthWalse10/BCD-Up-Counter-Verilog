...
REM
REM Generated by Vivado on Fri Dec 02 13:15:30 +0530 2022
...
echo "xvlog --incr --relax -prj bcd_up_counter_tb_vlog.prj"
call xvlog  --incr --relax -prj bcd_up_counter_tb_vlog.prj -log xvlog.log
